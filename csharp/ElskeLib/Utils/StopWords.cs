...
namespace ElskeLib.Utils
{
    public static class StopWords
    {
        ...
        {
            "&gt", "a", "a's", "able", "about", "above", "according", "accordingly", "across", "actually", "after",
            ...
            "are", "aren't", "aren’t", "arent", "around", "as", "aside", "ask", "asking", "associated", "at",
            ...
            "better", "between", "beyond", "big", "both", "brief", "but", "by", "c", "c'mon", "c's", "came", "can",
            "can't", "can’t", "cannot", "cant", "cause", "causes", "certain", "certainly", "changes", "clearly", "co",
            "com", "come", "comes", "concerning", "consequently", "consider", "considering", "contain", "containing",
            "contains", "corresponding", "could", "couldn't", "couldn’t", "couldnt", "course", "currently", "d", "day",
            "definitely", "described", "despite", "did", "didn't", "didn’t", "didnt", "different", "do", "does",
            "doesn't", "doesn’t", "doesnt", "doing", "don", "don't", "don’t", "done", "dont", "down", "downwards",
            "during", "e", "each", "edu", "eg", "eight", "either", "else", "elsewhere", "en", "enough", "entirely",
            "especially", "et", "etc", "even", "ever", "every", "everybody", "everyone", "everything", "everywhere",
            "ex", "exactly", "example", "except", "f", "far", "few", "fifth", "first", "five", "followed", "following",
            "follows", "for", "former", "formerly", "forth", "four", "from", "further", "furthermore", "g", "get",
            "gets", "getting", "give", "given", "gives", "go", "goes", "going", "gone", "good", "got", "gotten",
            "great", "greetings", "h", "had", "hadn't", "hadn’t", "hadnt", "happens", "hardly", "has", "hasn't",
            "hasn’t", "hasnt", "have", "haven't", "haven’t", "havent", "having", "he", "he'd", "he'll", "he's", "he’d",
            "he’ll", "he’s", "hello", "help", "hence", "her", "here", "here's", "here’s", "hereafter", "hereby",
            "herein", "hereupon", "hers", "herself", "hi", "him", "himself", "his", "hither", "hopefully", "how",
            "how's", "how’s", "howbeit", "however", "i", "i'd", "i'll", "i'm", "i've", "i’d", "i’ll", "i’m", "i’ve",
            "ie", "if", "ignored", "im", "immediate", "in", "inasmuch", "inc", "indeed", "indicate", "indicated",
            "indicates", "inner", "insofar", "instead", "into", "inward", "is", "isn't", "isn’t", "isnt", "it", "it'd",
            "it'll", "it's", "it’s", "its", "itself", "ive", "j", "just", "k", "keep", "keeps", "kept", "know", "known",
            "knows", "l", "last", "lately", "later", "latter", "latterly", "least", "less", "lest", "let", "let's",
            "let’s", "life", "like", "liked", "likely", "little", "lol", "look", "looking", "looks", "love", "ltd", "m",
            "made", "mainly", "make", "man", "many", "may", "maybe", "me", "mean", "meanwhile", "merely", "might",
            "more", "moreover", "most", "mostly", "much", "must", "mustn't", "mustn’t", "mustnt", "my", "myself", "n",
            "name", "namely", "nd", "near", "nearly", "necessary", "need", "needs", "neither", "never", "nevertheless",
            "new", "news", "next", "nine", "no", "nobody", "non", "none", "noone", "nor", "normally", "not", "nothing",
            "novel", "now", "nowhere", "o", "obviously", "of", "off", "often", "oh", "ok", "okay", "old", "on", "once",
            ...
            "seriously", "seven", "several", "shall", "shan't", "shan’t", "shant", "she", "she'd", "she'll", "she's",
            "she’d", "she’ll", "she’s", "should", "shouldn't", "shouldn’t", "shouldnt", "since", "six", "so", "some",
            ...
            "taken", "taking", "tell", "tends", "th", "than", "thank", "thanks", "thanx", "that", "that's", "that’s",
            "thats", "the", "their", "theirs", "them", "themselves", "then", "thence", "there", "there's", "there’s",
            ...
            "we'd", "we'll", "we're", "we've", "we’d", "we’ll", "we’re", "we’ve", "welcome", "well", "went", "were",
            "weren't", "weren’t", "werent", "weve", "what", "what's", "what’s", "whatever", "when", "when's", "when’s",
            "whence", "whenever", "where", "where's", "where’s", "whereafter", "whereas", "whereby", "wherein",
            "whereupon", "wherever", "whether", "which", "while", "whither", "who", "who's", "who’s", "whoever",
            "whole", "whom", "whose", "why", "why's", "why’s", "will", "willing", "wish", "with", "within", "without",
            "won't", "won’t", "wonder", "wont", "would", "wouldn't", "wouldn’t", "wouldnt", "x", "y", "y'all", "years", "yes",
            "yet", "you", "you'd", "you'll", "you're", "you've", "you’d", "you’ll", "you’re", "you’ve", "your", "yours",
